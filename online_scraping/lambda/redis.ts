...
export enum StatusType {
  ...
  NO_INVITATION_AUTHORITY = 'NO_INVITATION_AUTHORITY',
  REQUIRE_NAVER_COMMERCE_MEMBER_CONVERSION = 'REQUIRE_NAVER_COMMERCE_MEMBER_CONVERSION',
  REQUIRE_NAVER_COMMERCE_SIGNUP = 'REQUIRE_NAVER_COMMERCE_SIGNUP',
  NO_ACCOUNT_NUMBER = 'NO_ACCOUNT_NUMBER',
  NO_BSNO = 'NO_BSNO',
  NOT_NORMAL_STORE = 'NOT_NORMAL_STORE',
  LOGIN_FROM_UNAUTHORIZED_REGION = 'LOGIN_FROM_UNAUTHORIZED_REGION',
  WITHDRAWN_MEMBER = 'WITHDRAWN_MEMBER',
  REQUIRE_NAVER_PRIVACY_POLICY_CONSENT = 'REQUIRE_NAVER_PRIVACY_POLICY_CONSENT',
  CONSECUTIVE_CAPTCHA_FAILURES = 'CONSECUTIVE_CAPTCHA_FAILURES',
